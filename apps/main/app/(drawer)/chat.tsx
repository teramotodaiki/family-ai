...
const styles = StyleSheet.create({
  ...
  customHeader: {
    ...
    paddingHorizontal: 16, paddingBottom: 12, backgroundColor: '#000',
    borderBottomWidth: 1, borderBottomColor: '#1a1a1a',
  },
  headerButton: { width: 44, height: 44, justifyContent: 'center', alignItems: 'center' },
  headerTitle: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  headerTitleText: { color: '#fff', fontSize: 16, fontWeight: '600', marginRight: 4 },
  messagesContainer: { flex: 1 },
  suggestionsContainer: { padding: 16, gap: 12 },
  suggestionCard: { backgroundColor: '#0f0f0f', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#1a1a1a' },
  suggestionText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  suggestionSubtext: { color: '#888', fontSize: 12, marginTop: 4 },
  messageBubble: { marginHorizontal: 16, marginVertical: 8, padding: 12, borderRadius: 12 },
  userMessage: { backgroundColor: '#1a1a1a', alignSelf: 'flex-end' },
  aiMessage: { backgroundColor: '#0f0f0f', alignSelf: 'flex-start' },
  messageText: { color: '#fff', fontSize: 16 },
  inputContainer: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingTop: 8, borderTopWidth: 1, borderTopColor: '#1a1a1a' },
  attachButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#1a1a1a', justifyContent: 'center', alignItems: 'center', marginRight: 8 },
  textInput: { flex: 1, backgroundColor: '#1a1a1a', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, color: '#fff', fontSize: 16, maxHeight: 100 },
  sendButton: { marginLeft: 8, width: 32, height: 32, borderRadius: 16, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center' },
  attachmentOptions: { position: 'absolute', left: 0, right: 0, backgroundColor: '#1a1a1a', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20 },
  attachmentOption: { alignItems: 'center', marginBottom: 16 },
  attachmentLabel: { color: '#fff', fontSize: 12, marginTop: 4 },
  circleIcon: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#000', borderWidth: 2, borderColor: '#fff' },
  attachmentActions: { marginTop: 20 },
  attachmentActionButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, gap: 12 },
  attachmentActionText: { color: '#fff', fontSize: 16 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { backgroundColor: '#1a1a1a', borderRadius: 16, padding: 20, width: '90%', maxWidth: 400 },
  modalTitle: { color: '#fff', fontSize: 18, fontWeight: '600', marginBottom: 16 },
  modelOption: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 16, borderTopWidth: 1, borderTopColor: '#333' },
  modelInfo: { flex: 1 },
